...
- GuardFed-AD2+ config: fixed AD2+ with risk weight 0.9, violation weight 0.25, keep ratio 0.8, temperature 0.35, utility/centrality/alignment weights 1.0/0.35/0.35, root norm mode.
...
- GuardFed-AD2+ first=7, second=5, top2=12 out of 60 metric cells.
