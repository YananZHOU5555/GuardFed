...
- Display rule: in paper-style tables, invalid AEOD/ASPD cells are shown as `N/E` (not eligible) instead of misleading near-zero fairness values; raw selected values remain in the CSV.
