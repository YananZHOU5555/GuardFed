...
- `02_ServerRoot_FULL`：完整 server/root 分布表，包含 Adult 和 COMPAS、IID/non-IID、Benign/FedSA、三种 server/root 分布层级，以及 TVD、ACC、AEOD、ASPD、FairAvg、Score。共 24 行明细，底部附相关性/差值摘要。
