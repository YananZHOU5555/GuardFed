...
- GuardFed-AD2+ config selection mode: datasetopt; sort objective=top2. One complete AD2+ configuration is selected per dataset, never per attack/metric cell.
- GuardFed-AD2+ selected config(s): compas: mode=fixed, budget=0.12, metric=aeod_aspd, risk=0.1, viol=0.02, keep=1, temp=0.8, utility=3, centrality=0.2, alignment=1, clip=5, norm=root, reweight=true | adult: mode=fixed, budget=0.1, metric=aeod_aspd, risk=0.1, viol=0.02, keep=1, temp=0.8, utility=3, centrality=0.2, alignment=1.5, clip=5, norm=root, reweight=true.
...
- Fairness ranking validity: Adult ACC >= 80%, COMPAS ACC >= 60%, and ACC within 5 percentage points of the scenario-best ACC; low-ACC fairness zeros are shown but cannot win first/second fairness rank.
...
- GuardFed-AD2+ first=10, second=10, top2=20 out of 60 metric cells.
