...
- GuardFed-AD2+ config: best single global sweep configuration selected from 25 complete AD2+ configurations; mode=fixed, budget=0.12, metric=aeod_aspd, risk=0.1, viol=0.02, keep=1, temp=0.8, utility=3, centrality=0.2, alignment=1, clip=5, norm=root.
...
- GuardFed-AD2+ first=11, second=7, top2=18 out of 60 metric cells.
